const menu = [
  ...
  },
  {
    ...
    price: 5.99,
    img:
      "https://photos.bigoven.com/recipe/hero/authentic-dan-dan-noodles-orie-24634f.jpg?h=300&w=300",
...
const categoryList = () => {
  ...
  buttonsDOM.innerHTML = categoryBtns
...
const menuList = (menu) => {
  let displayMenu = menu.map((food) => {
    ...
    <div class="menu-info">
      ...
      <div class="menu-text"> 
        <p> ${food.desc} </p>
        <p> <strong style="color: crimson;"> Origin: </strong> ${food.category} </p> 
      </div>
    </div>
  </div>
  `
